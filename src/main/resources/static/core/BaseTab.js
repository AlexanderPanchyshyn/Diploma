...
export class BaseTab {
    ...
    initTabUI(createServiceFn, protocolName) {
            ...
            { connectBtnId: 'ws-connect', disconnectBtnId: 'ws-disconnect', pingBtnId: 'ws-ping' },
            {
                onConnect: () => {
                    if (this.service?.connect) {
                        ...
                        logger.log(`${protocolName} connection initialized.`);
                    }
                },
                onDisconnect: () => {
                    if (this.service?.disconnect) {
                        ...
                        logger.log(`${protocolName} connection closed.`);
                    }
                },
                onPing: () => {
    ...
    setMaxJitter(metricsBox, metrics) {
        ...
        metricsBox.update({ ...metrics, maxJitter: maxJitter });
    }
